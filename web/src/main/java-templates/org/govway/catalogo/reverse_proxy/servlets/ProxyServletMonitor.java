...
public class ProxyServletMonitor extends org.eclipse.jetty.ee10.proxy.ProxyServlet.Transparent {
	...
	public static final String PROXY_MONITOR_PREFIX = "${org.govway.catalogo.servlet.monitor.path}";
