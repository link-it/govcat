 ...
 * modifica: vale quindi il comportamento odierno (config dentro la WAR).
 *
...
public class ExternalLog4j2EnvironmentPostProcessor implements EnvironmentPostProcessor {
	...
	static final String PATH_PROPERTY = "org.govway.catalogo.web.log4j2.path";
	static final String DEFAULT_PATH = "/var/govcat/conf/govcat-web-log4j2.xml";
	...
	public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
		...
		// else: nessuna modifica -> fallback alla config inclusa nella WAR (comportamento odierno)
	}
