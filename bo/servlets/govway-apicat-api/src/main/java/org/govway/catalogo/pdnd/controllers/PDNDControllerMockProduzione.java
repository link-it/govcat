...
import org.govway.catalogo.PdndMockControllerProduzione;
...
@PdndMockControllerProduzione
public class PDNDControllerMockProduzione implements GatewayApi, HealthApi {


	private PDNDMockServer server;

	public PDNDControllerMockProduzione() {
		this.server = new PDNDMockServer("produzione");
	}
