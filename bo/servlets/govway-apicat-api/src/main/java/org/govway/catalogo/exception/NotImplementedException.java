...
/**
 * Operazione non supportata dalla configurazione attiva: mappata su HTTP 501.
 */
public class NotImplementedException extends AbstractGovCatException {
	 ...
	 */
	public NotImplementedException(ErrorCode errorCode, Map<String, String> parameters) {
	 ...
	 * @param cause la causa dell'eccezione
	 */
	public NotImplementedException(ErrorCode errorCode, Map<String, String> parameters, Throwable cause) {
