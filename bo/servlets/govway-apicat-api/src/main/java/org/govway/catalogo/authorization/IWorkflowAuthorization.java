...
public interface IWorkflowAuthorization<CREATE, UPDATE, ENTITY> extends IAuthorization<CREATE, UPDATE, ENTITY> {

	public void authorizeCambioStato(ENTITY entity, String stato);
