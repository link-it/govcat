...
public class ItemMessaggioServizioAssembler extends RepresentationModelAssemblerSupport<MessaggioServizioEntity, ItemMessaggio> {
	...
	public ItemMessaggioServizioAssembler() {
		super(ServiziController.class, ItemMessaggio.class);
	}

	@Override
	public ItemMessaggio toModel(MessaggioServizioEntity entity) {
	...
	public MessaggioServizioEntity toEntity(MessaggioCreate src, ServizioEntity servizio) {
	...
	public MessaggioServizioEntity toEntity(MessaggioUpdate src, MessaggioServizioEntity entity) {
		BeanUtils.copyProperties(src, entity);
		entity.setData(new Date());
