...
import org.govway.catalogo.PdndMockV3ControllerProduzione;
...
@PdndMockV3ControllerProduzione
public class PDNDControllerMockV3Produzione implements GatewayApi {

	private PDNDMockServerV3 server;

	public PDNDControllerMockV3Produzione() {
		this.server = new PDNDMockServerV3("produzione");
	}
