...
/**
 * Entity representing a union view of services and groups.
 *
 * This entity maps to a database view (servizi_gruppi) rather than a physical table.
 * The view is created manually in the database and should not be generated by Hibernate schema tools.
 *
 * Using @Subselect prevents Hibernate from generating DDL for this entity, treating it as a view.
 */
@Getter
@Setter
@Entity
@Subselect("SELECT * FROM servizi_gruppi")
