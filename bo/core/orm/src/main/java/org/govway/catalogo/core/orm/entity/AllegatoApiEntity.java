...
@Setter
@Entity
@Table(name = "allegati_api")
public class AllegatoApiEntity {
    ...
    @Id
    @Column(name = "id")
    @GeneratedValue(generator = "seq_allegati_api", strategy = GenerationType.SEQUENCE)
    @SequenceGenerator(name = "seq_allegati_api", sequenceName = "seq_allegati_api", allocationSize = 1)
	private Long id;
