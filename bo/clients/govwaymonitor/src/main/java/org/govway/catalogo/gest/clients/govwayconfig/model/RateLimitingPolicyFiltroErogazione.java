...
import org.govway.catalogo.gest.clients.govwayconfig.model.RateLimitingPolicyFiltro;
...
public class RateLimitingPolicyFiltroErogazione extends RateLimitingPolicyFiltro {
 ...
 @Pattern(regexp="^[0-9A-Za-z]+$") @Size(max=255)  public String getSoggettoFruitore() {
  ...
  public String toString() {
    ...
    sb.append("    soggettoFruitore: ").append(toIndentedString(soggettoFruitore)).append("\n");
    sb.append("}");
    return sb.toString();
  }
