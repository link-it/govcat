...
import { BreadcrumbComponent, ConfigService, SearchBarFormComponent, Tools, EventsManagerService, COMPONENTS_IMPORTS } from '@linkit/components';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ...COMPONENTS_IMPORTS],
