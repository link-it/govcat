...
describe('OrganizzazioniComponent', () => {
  let component: OrganizzazioniComponent;
  ...
  it('should have static Name', () => {
    expect(OrganizzazioniComponent.Name).toBe('OrganizzazioniComponent');
  });
  ...
  it('should navigate to new on _onNew', () => {
    component._onNew();
    expect(mockRouter.navigate).toHaveBeenCalledWith(['organizzazioni', 'new']);
  });
