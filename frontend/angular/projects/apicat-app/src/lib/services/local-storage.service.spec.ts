...
describe('LocalStorageService', () => {
    ...
    it('should remove an item', () => {
        ...
        // getString returns default value '' (empty string) when key is not found
        expect(service.getString('testKey')).toBe('');
    });
    ...
    it('should clear all items', () => {
        ...
        service.clear();
        // getString returns default value '' (empty string) when key is not found
        expect(service.getString('testKey1')).toBe('');
        expect(service.getString('testKey2')).toBe('');
    });
