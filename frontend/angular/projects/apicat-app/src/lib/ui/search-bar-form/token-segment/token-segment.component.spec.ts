...
describe('TokenSegmentComponent', () => {
    ...
    let mockConfigService = {
        getConfiguration: vi.fn().mockReturnValue({ AppConfig: { GOVAPI: { HOST: 'test_host' } } })
    };
    ...
    it('should emit onAction event with token value when _onAction is called', () => {
        ...
        vi.spyOn(component.onAction, 'emit');
    ...
    it('should return correct value when _getObjectValue is called', () => {
        ...
        vi.spyOn(component.utilsLib, 'getObjectValue').mockImplementation((data, field) => data[field]);
