...
describe('PhotoBase64Component', () => {
    ...
    beforeEach(() => {
        ...
        TestBed.configureTestingModule({
            imports: [PhotoBase64Component, TranslateModule.forRoot()],
    ...
    it('should emit imageLoaded', () => {
        const spy = vi.spyOn(component.imageLoaded, 'emit');
    ...
    it('should set imageError when file is not an image', () => {
        ...
        component.fileChangeEvent(fileInput as any);
        expect(component.imageError).toEqual('APP.MESSAGE.VALIDATION.OnlyImages');
    });
    ...
    it('should set imageError when file size is too large', () => {
        ...
        component.fileChangeEvent(fileInput as any);
        expect(component.imageError).toEqual('APP.MESSAGE.VALIDATION.MaxFileSize');
    });
