...
export class AgidJwtTrackingEvidenceDialogComponent implements OnInit {
    ...
    tipoPolicy: string = 'pdnd_audit';
    title: string = 'APP.AUTHENTICATION.TITLE.GenerateTrackingEvidence';
    ...
    useResultModal() {
        ...
        this.closeModal({ trackingEvidence: signedToken, voucher: result });
    }
    ...
    async generateJWT(values: any) {
        ...
        try {
            ...
            client_assertion = await rs.KJUR.jws.JWS.sign("RS256", sHeader, sPayload, rsaKey as rs.RSAKey);
