...
export class AgidJwtSignatureDialogComponent implements OnInit {
    ...
    formGroup: FormGroup = new FormGroup({
        ...
        audience: new FormControl({ value: '', disabled: false }, [Validators.required]),
        audience_integrity: new FormControl({ value: '', disabled: false }, [Validators.required]),
    ...
    initForm() {
        ...
        this.formGroup.get('audience_integrity')?.setValue(this._audience_integrity);
    }
