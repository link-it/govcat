...
export interface UtenteOrganizzazione {
    organizzazione: ItemOrganizzazione;
    /**
     * Ruolo dell'utente nell'organizzazione. `null` significa "nessun
     * ruolo" (utente associato in sola lettura).
     */
